...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A custom mobile therapy application developed through client consultation and requirement analysis. Built with React Native and SQLite, providing specialized therapeutic tools and features.",
